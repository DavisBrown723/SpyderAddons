...
class SpyderAddons_RscListNBox {
...
class SpyderAddons_RscStructuredText
{
	access = 0;
	type = 13;
	idc = -1;
...
class SpyderAddons_RscControlsGroup
{
	class VScrollbar
	{
		color[] =
