...
class Insurgency_RscButton
{
	...
	soundEnter[] =
	{
		"\A3\ui_f\data\sound\Insurgency_RscButton\soundEnter",
		0.09,
		1
	};
	soundPush[] =
	{
		"\A3\ui_f\data\sound\Insurgency_RscButton\soundPush",
		0.09,
		1
	};
	soundClick[] =
	{
		"\A3\ui_f\data\sound\Insurgency_RscButton\soundClick",
		0.09,
		1
	};
	soundEscape[] =
	{
		"\A3\ui_f\data\sound\Insurgency_RscButton\soundEscape",
		0.09,
		1
	};
	textureNoShortcut = "";
